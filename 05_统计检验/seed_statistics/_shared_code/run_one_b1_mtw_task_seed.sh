#!/bin/bash
# B1 (RF), MTW-CM. Usage: run_one_b1_mtw_task_seed.sh "D2-M,17"
...
LANDSCAPE_DIR="$SHARED_DIR/../B1_MTW_${task_dirname}_seed_landscape"
LOG_DIR="$LANDSCAPE_DIR/logs"
mkdir -p "$LOG_DIR"
"${PYTHON_EXE:-python}" "$SHARED_DIR/run_b1_mtw_seed_task.py" \
